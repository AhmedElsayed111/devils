...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(vipdevils..":NameBot:")
...
var =  'مطور السورس'
elseif redis:sismember(vipdevils..':SUDO_BOT:',UserID) then
var = 'مطور البوت ' 
elseif redis:sismember(vipdevils..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(vipdevils..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء ' 
elseif redis:sismember(vipdevils..'owners:'..ChatID,UserID) then
var = 'مدير البوت ' 
elseif redis:sismember(vipdevils..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت ' 
elseif redis:sismember(vipdevils..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ' 
else
var = 'فقط عضو ' 
end
...
if msg.edited then
redis:incr(vipdevils..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(vipdevils..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(vipdevils..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(vipdevils..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(vipdevils..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(vipdevils..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(vipdevils..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(vipdevils..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(vipdevils..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(vipdevils..':SUDO_BOT:')
message = '-  قائمه الـمـطـوريـن : \n\n`- مطور اساسي`**\n'..SUDO_USER..' ⇽ ❪' ..SUDO_ID.. '❫\n*———————— *\n'
if #list==0 then  message = message.."* - لا يوجد مطورين حاليا \n⋆*"
else
for k,v in pairs(list) do
local info = redis:hgetall(vipdevils..'username:'..v)
local count = redis:scard(vipdevils..'mtwr_count'..v)
...
local monsha = redis:smembers(vipdevils..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————  \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(vipdevils..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(vipdevils..'admins:'..msg.chat_id_)
...
local list = redis:smembers(vipdevils..'whitelist:'..msg.chat_id_)
...
if redis:sismember(vipdevils..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(vipdevils..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(vipdevils..'banned:'..Group,User) then 
return true 
else
return false
end 
...
if redis:sismember(vipdevils..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(vipdevils..'gban_users')
...
local list = redis:smembers(vipdevils..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(vipdevils..':Filter_Word:'..msg.chat_id_,word) then 
return  "- **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع↯" 
else
redis:sadd(vipdevils..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(vipdevils..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(vipdevils..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(vipdevils..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(vipdevils..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(vipdevils..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(vipdevils..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
local list = redis:smembers(vipdevils..'group:ids')
message = '- **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(vipdevils..'group:name'..v)
if info then 
...
<link href="https://fonts.vipdevilsapis.com/css?family=Harmattan" rel="stylesheet">
...
redis:del(
vipdevils..'group:add'..id_group,
vipdevils..'lock_link'..id_group, 
vipdevils..'lock_id'..id_group,
vipdevils..'lock_spam'..id_group, 
vipdevils..'lock_webpage'..id_group,
vipdevils..'lock_markdown'..id_group,
vipdevils..'lock_flood'..id_group,
vipdevils..'lock_bots'..id_group,
vipdevils..'mute_forward'..id_group,
vipdevils..'mute_contact'..id_group,
vipdevils..'mute_location'..id_group,
vipdevils..'mute_document'..id_group,
vipdevils..'mute_keyboard'..id_group,
vipdevils..'mute_game'..id_group,
vipdevils..'mute_inline'..id_group,
vipdevils..'lock_username'..id_group,
vipdevils..'num_msg_vipdevils'..id_group,
vipdevils..'replay'..id_group
)
redis:srem(vipdevils..'group:ids',id_group)
end
...
redis:hset(vipdevils..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(vipdevils..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
if redis:get(vipdevils..'group:add'..msg.chat_id_) then  return '⋆**المجموعه بالتأكيد تم تفعيلها' end
...
redis:setex(vipdevils..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(vipdevils..':addnumberusers') or 0)
...
local lock_service = redis:get(vipdevils..'lock_service')
if lock_service then 
sendMsg(msg.chat_id_,msg.id_,'⋆* تم تفعيل المجموعه بنجاح .  𖠭 . \n*⋆ ورفع كل المشرفين\n [ 𝚂𝙾𝚄𝚁𝙲𝙴  𖣫 ](t.me/sourcevipdevils)')
else
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(vipdevils..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(vipdevils..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
vipdevils..'group:add'..msg.chat_id_,true,
vipdevils..'lock_link'..msg.chat_id_,true, 
vipdevils..'lock_id'..msg.chat_id_,true,
vipdevils..'lock_spam'..msg.chat_id_,true,
vipdevils..'lock_webpage'..msg.chat_id_,true,
vipdevils..'lock_markdown'..msg.chat_id_,true,
vipdevils..'lock_flood'..msg.chat_id_,true,
vipdevils..'lock_bots'..msg.chat_id_,true,
vipdevils..'mute_forward'..msg.chat_id_,true,
vipdevils..'mute_contact'..msg.chat_id_,true,
vipdevils..'mute_location'..msg.chat_id_,true,
vipdevils..'mute_document'..msg.chat_id_,true,
vipdevils..'mute_keyboard'..msg.chat_id_,true,
vipdevils..'mute_game'..msg.chat_id_,true,
vipdevils..'mute_inline'..msg.chat_id_,true,
vipdevils..'lock_username'..msg.chat_id_,true,
vipdevils..'num_msg_vipdevils'..msg.chat_id_,5, 
vipdevils..'replay'..msg.chat_id_,true
)

redis:sadd(vipdevils..'group:ids',msg.chat_id_) 
redis:sadd(vipdevils..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(vipdevils..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(vipdevils..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(vipdevils..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
if redis:sismember(vipdevils..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء  \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID,'username',Resolv)
redis:sadd(vipdevils..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء في البوت \n↯',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(vipdevils..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء \n↯',17,USERCAR) 
end
redis:srem(vipdevils..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(vipdevils..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء اساسي \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID,'username',Resolv)
redis:sadd(vipdevils..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء اساسي في البوت \n↯',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(vipdevils..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء اساسي\n↯',17,USERCAR) 
end
redis:srem(vipdevils..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(vipdevils..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد عضو مميز \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح عضو مميز \n↯',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(vipdevils..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس عضو مميز \n↯',17,USERCAR) 
end
redis:srem(vipdevils..'whitelist:'..ChatID,UserID)
...
if redis:sismember(vipdevils..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد مدير \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..'owners:'..ChatID,UserID)
...
if redis:sismember(vipdevils..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ادمن \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح ادمن \n↯',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(vipdevils..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مدير \n↯',17,USERCAR) 
end
redis:srem(vipdevils..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم تنزيله من المدير  \n↯',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(vipdevils..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس ادمن \n↯',17,USERCAR) 
end
redis:srem(vipdevils..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(vipdevils..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم حظره  \n↯',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(vipdevils..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتأكيد الغاء حظره  \n↯',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء حظره \n↯',17,USERCAR) 
end
redis:srem(vipdevils..'banned:'..ChatID,UserID)
...
if redis:sismember(vipdevils..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتأكيد كتمه  \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم كتمه \n↯',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(vipdevils..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم بالتاكيد الغاء كتمه  \n↯',17,USERCAR) 
end
redis:srem(vipdevils..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء كتمه  \n↯',17,USERCAR) 
end
...
redis:hset(vipdevils..'username:'..UserID, 'username',Resolv)
redis:sadd(vipdevils..'gban_users',UserID)
...
redis:srem(vipdevils..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم الغاء حظره العام \n↯',17,USERCAR) 
end
...
if redis:sismember(vipdevils..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد مطور \n↯',17,USERCAR) 
end
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم ترقيته ليصبح مطور \n↯',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(vipdevils..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مطور \n↯',17,USERCAR) 
end
redis:srem(vipdevils..':SUDO_BOT:',UserID)
...
redis:hset(vipdevils..'username:'..UserID, 'username', UserName)
redis:sadd(vipdevils..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو ⇽ ❪ '..UserName..' ❫\n- **الايدي ⇽ ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح منشىء في البوت \n↯')
end
...
if redis:sismember(vipdevils..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'- **العضو ⇽ ❪ '..UserName..' ❫\n- **الايدي ⇽ ❪ `'..UserID..'` ❫\n- **تم بالتأكيد حظره \n↯') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
return sendMsg(ChatID,MsgID,"- **لا يمكنك كتم  مطور السورس\n⋆") 
elseif  UserID == 1289997696 then 
return sendMsg(ChatID,MsgID,"- **لا يمكنك كتم  قلبي\n⋆") 
elseif  UserID == 1289997696 then 
return sendMsg(ChatID,MsgID,"- **لا يمكنك كتم  مطور السورس\n⋆") 
elseif  UserID == 656329268 then 
return sendMsg(ChatID,MsgID,"- **لا يمكنك كتم  قلبي\n⋆") 
...
Restrict(ChatID,UserID,1)
redis:hset(vipdevils..'username:'..UserID, 'username', Resolv)
redis:sadd(vipdevils..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(vipdevils..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n- الايدي ⇽ ❪ '..UserID..' ❫\n- تم فگ تقييد آلعضـو بنجآح \n↯',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(vipdevils..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(vipdevils..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'-**العضو ⇽ '..USERNAME..' \n-** الايدي ⇽ (`'..UserID..'`)\n-**انه بالتأكيد ليس مطور \n✓') end
redis:srem(vipdevils..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'-العضو ⇽ ❪ '..USERNAME..' ❫\n-الايدي ⇽ ❪ '..UserID..' ❫\n-تم تنزيله من المطورين \n↯',17,USERCAR) 
end
...
if redis:get(vipdevils..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(vipdevils..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(vipdevils..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(vipdevils..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*-* اعدادات المجموعه : \n"
.."\n1-╿التعديل ⇽ "..(redis:get(vipdevils..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط ⇽ "..(redis:get(vipdevils..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك ⇽ "..(redis:get(vipdevils..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات ⇽ "..(redis:get(vipdevils..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار ⇽ "..(redis:get(vipdevils..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش ⇽ "..(redis:get(vipdevils..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب ⇽ "..(redis:get(vipdevils..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان ⇽ "..(redis:get(vipdevils..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات ⇽ "..(redis:get(vipdevils..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات ⇽ "..(redis:get(vipdevils..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار ⇽ "..(redis:get(vipdevils..'num_msg_vipdevils'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه ⇽ "..(redis:get(vipdevils..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه ⇽ "..(redis:get(vipdevils..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين ⇽ "..(redis:get(vipdevils..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب ⇽"..(redis:get(vipdevils..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور ⇽ "..(redis:get(vipdevils..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو ⇽ "..(redis:get(vipdevils..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات ⇽ "..(redis:get(vipdevils..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت ⇽ "..(redis:get(vipdevils..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات ⇽ "..(redis:get(vipdevils..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات ⇽ "..(redis:get(vipdevils..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه ⇽ "..(redis:get(vipdevils..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع ⇽ "..(redis:get(vipdevils..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات ⇽ "..(redis:get(vipdevils..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات ⇽ "..(redis:get(vipdevils..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد ⇽ "..(redis:get(vipdevils..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب ⇽ "..welcomex
.."\n*2-│*الردود ⇽ "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك ⇽ "..(redis:get(vipdevils..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات ⇽ "..(redis:get(vipdevils..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل ⇽ "..(redis:get(vipdevils..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط ⇽ "..(redis:get(vipdevils..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار ⇽ "..(redis:get(vipdevils..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش ⇽ "..(redis:get(vipdevils..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب ⇽ "..(redis:get(vipdevils..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان ⇽ "..(redis:get(vipdevils..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد ⇽ "..(redis:get(vipdevils..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات ⇽ "..(redis:get(vipdevils..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار ⇽ "..(redis:get(vipdevils..'num_msg_vipdevils'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه ⇽ "..(redis:get(vipdevils..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور ⇽ "..(redis:get(vipdevils..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط ⇽ "..(redis:get(vipdevils..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه ⇽ "..(redis:get(vipdevils..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو ⇽ "..(redis:get(vipdevils..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
